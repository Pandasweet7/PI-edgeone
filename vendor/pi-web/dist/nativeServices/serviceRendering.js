...
export function renderSystemdUnit(plan, service) {
...
export function renderLaunchdPlist(plan, service, logDirectory) {
    assertPlanService(plan, service);
...
function assertPlanService(plan, service) {
...
function systemdEscape(value, escapeSpaces) {
    ...
    for (const character of value) {
        ...
        if (character === "\\")
            ...
            escaped += escapeSpaces ? "\\x22" : '\\"';
        else if (character === "'" && escapeSpaces)
            escaped += "\\x27";
        else if (character === " " && escapeSpaces)
            escaped += "\\x20";
        else if (character === "\n")
...
function plistProgramArguments(arguments_) {
...
//# sourceMappingURL=serviceRendering.js.map