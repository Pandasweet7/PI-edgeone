...
import { additionalCommands, fallbackDockerStatus, formatVersion, installationLabel, messageCount, recommendedCommand, shouldShowUpdatesPanel, statusFor } from "./updatesLogic.js";
function runCommandInTerminal(terminal, label, command) {
...
function renderCommandActions(html, terminal, label, command) {
    return html `
...
function renderCommand(html, terminal, label, command) {
    return html `
...
function updatesRuntimeHintFromModuleUrl(moduleUrl) {
    try {
...
function renderUpdatesPanel(html, terminal, state) {
