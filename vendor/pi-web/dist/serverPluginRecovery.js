 ...
 */
export function loadServerPluginRecoveryConfig(options = {}) {
...
export function disableServerPlugin(pluginId, options = {}) {
...
export function setServerPluginSafeStart(safeStart, options = {}) {
...
function resolveSafeStart(root, path) {
    const configuredServerPlugins = root[SERVER_PLUGINS_CONFIG_KEY];
    if (configuredServerPlugins === undefined)
        return {};
...
//# sourceMappingURL=serverPluginRecovery.js.map