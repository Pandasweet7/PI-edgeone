...
export function applyWorkspaceFilePreviewResponsePolicy(reply, policy) {
    return reply
 ...
 */
export function applyWorkspaceFilePreviewErrorResponsePolicy(reply) {
    return applyWorkspaceFilePreviewResponsePolicy(reply, workspaceFilePreviewErrorResponsePolicy());
}
//# sourceMappingURL=filePreviewResponseHeaders.js.map