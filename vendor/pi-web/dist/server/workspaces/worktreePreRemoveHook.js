...
export const realWorktreePreRemoveHookProbe = {
...
export function worktreePreRemoveHookPath(commandWorkspacePath) {
 ...
 */
export function composeWorktreePreRemoveCommand(hookPath, targetPath, removalCommand) {
    return `${shellQuote(hookPath)} ${shellQuote(targetPath)} && ${removalCommand}`;
}
function shellQuote(value) {
    return `'${value.replaceAll("'", "'\\''")}'`;
}
//# sourceMappingURL=worktreePreRemoveHook.js.map