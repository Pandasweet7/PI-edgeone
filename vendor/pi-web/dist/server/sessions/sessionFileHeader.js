 ...
 */
export async function readSessionHeaderSummary(sessionFile) {
    let file;
    try {
...
async function streamHeaderSummary(file) {
    ...
    for (;;) {
        ...
        if (position >= HEADER_READ_CAP_BYTES)
            return undefined;
    }
}
/**
...
function nonEmptyStringField(header, key) {
    const value = header[key];
    return typeof value === "string" && value !== "" ? value : undefined;
}
//# sourceMappingURL=sessionFileHeader.js.map