...
const strongestMode = (left, right) => left === "forced" || right === "forced" ? "forced" : "scheduled";
const noopLogger = {
    info() { },
    warn() { },
    error() { },
...
export class ModelCatalogRefresher {
     ...
     */
    queueRefresh(mode, isRetry = false) {
...
//# sourceMappingURL=modelCatalogRefresher.js.map