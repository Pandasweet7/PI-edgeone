...
export function sessionEnvironmentFacts({ env }) {
    const facts = [
 ...
 */
export function sessionEnvironmentPromptSections({ env, enabled }) {
    if (!enabled)
        return [];
    return [sessionEnvironmentFacts({ env })];
}
//# sourceMappingURL=sessionEnvironmentFacts.js.map